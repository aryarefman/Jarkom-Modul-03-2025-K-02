...
#### Narvi
```
mysql -u root -proot123 laravel_db -e "SHOW TABLES; SELECT * FROM test;"
```
<img width="1218" height="366" alt="image" src="https://github.com/user-attachments/assets/921d23e8-56fb-459b-b0d7-4bc63a69c895" />

#### Real Time
- Palantir
```
mysql -u root -proot123 laravel_db <<'EOF'
CREATE TABLE test2 (
    id INT AUTO_INCREMENT PRIMARY KEY,
    nama VARCHAR(255),
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP
...
INSERT INTO test2 (nama) VALUES ('Frodo'), ('Samwise'), ('Gandalf');
SELECT * FROM test2;
EOF
```
...
```
sleep 2
mysql -u root -proot123 laravel_db -e "SHOW TABLES; SELECT * FROM test2;"
```
<img width="1030" height="454" alt="image" src="https://github.com/user-attachments/assets/a5d46536-db41-4228-8d2e-cdb390bbced2" />
...
echo "=============================================="
```
<img width="1266" height="819" alt="image" src="https://github.com/user-attachments/assets/7f84c99e-a4d4-4a60-8106-156aaca79e9d" />
...
echo "=============================================="
```
## UJI COBA - Client (Contoh:Gilgalad)
```
